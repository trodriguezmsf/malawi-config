DELETE FROM global_property WHERE property = 'emrapi.sqlSearch.patientsDischarge';
SELECT uuid() INTO @uuid;
INSERT INTO global_property (`property`, `property_value`, `description`, `uuid`)
VALUES ('emrapi.sqlSearch.patientsDischarge',
"SELECT DISTINCT
...
FROM visit v
    ...
    INNER JOIN concept_name cn ON o.value_coded = cn.concept_id AND cn.concept_name_type = 'FULLY_SPECIFIED'
                                AND cn.voided is FALSE AND cn.name = 'Discharge'
WHERE v.date_stopped IS NULL
ORDER BY o.obs_datetime;",'Discharge',@uuid);