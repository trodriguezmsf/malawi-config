DELETE FROM global_property WHERE property = 'emrapi.sqlSearch.patientsAdmittedToSurgicalWard';
...
from bed
        ...
        ORDER BY bpam.date_started DESC",'Admitted to Surgical Ward',uuid());