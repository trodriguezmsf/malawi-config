DELETE FROM global_property WHERE property = 'emrapi.sqlSearch.PatientsMovementtoSurgicalWard';
SELECT uuid() INTO @uuid;
INSERT INTO global_property (`property`, `property_value`, `description`, `uuid`)
VALUES ('emrapi.sqlSearch.PatientsMovementtoSurgicalWard',
"SELECT DISTINCT
        ...
        INNER JOIN concept_name cn ON o.value_coded = cn.concept_id AND cn.concept_name_type = 'FULLY_SPECIFIED' AND cn.voided is FALSE
                                                                    AND cn.name = 'Movement to Surgical Ward' AND o.date_created > bpam.date_created
    WHERE v.date_stopped IS NULL
    ORDER BY o.obs_datetime;",'Movement to Surgical Ward',@uuid);