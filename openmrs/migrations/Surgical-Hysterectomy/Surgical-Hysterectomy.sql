...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"HY, Abdominal exploration findings, other","Abdominal exploration findings, other","Text","Misc",false);
