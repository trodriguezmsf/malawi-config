...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"CS, Date of appointment for results","Date of appointment for results","Date","Misc",false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"CS, Aceto-white areas, Size","Aceto-white areas, Size","Numeric","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"CS, Other lesion, Size","Other lesion, Size","Numeric","Misc",false);
...
VALUES ((select concept_id from concept_name where name = "CS, Aceto-white areas, Size" and concept_name_type = "FULLY_SPECIFIED"  and locale = "en"  and voided = 0),NULL,NULL,NULL,NULL,NULL,NULL,"",1,1);
INSERT INTO concept_numeric (concept_id,hi_absolute,hi_critical,hi_normal,low_absolute,low_critical,low_normal,units,precise,display_precision)
VALUES ((select concept_id from concept_name where name = "CS, Other lesion, size" and concept_name_type = "FULLY_SPECIFIED"  and locale = "en"  and voided = 0),NULL,NULL,NULL,NULL,NULL,NULL,"",1,1);
INSERT INTO concept_numeric (concept_id,hi_absolute,hi_critical,hi_normal,low_absolute,low_critical,low_normal,units,precise,display_precision)
