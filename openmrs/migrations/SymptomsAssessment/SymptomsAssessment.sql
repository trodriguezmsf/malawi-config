...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"SA, Nausea and vomiting  severity of symptom","Nause and vomiting severity","Coded","Misc",false);
...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"SA, Abnormal vaginal bleeing severity of symptom","Abnormal vaginal bleeding  severity","Coded","Misc",false);
