...
from patient_program patientprogram
    #Block to fetch the values for 'Oncogynae program state' column
         LEFT OUTER JOIN
            (select cn.name as 'oncogynaeName', patientprogram.patient_id,patientprogram.date_enrolled as 'Date_of_Oncogynae_Program' from patient_program patientprogram
