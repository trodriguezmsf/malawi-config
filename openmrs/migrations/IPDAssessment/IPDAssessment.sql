...
VALUES ((select concept_id from concept_name where name = "IPDA, VAS score" and concept_name_type = "FULLY_SPECIFIED"  and locale = "en"  and voided = 0),99.9,NULL,NULL,0,NULL,NULL,"",1,1);
