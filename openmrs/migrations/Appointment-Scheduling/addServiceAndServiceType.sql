...
BEGIN
 ...
 DECLARE appointment_service_type_count INT;
  ...
  IF @appointment_service_count = 0 AND service_name IS NOT NULL THEN
     ...
     (service_name,service_description,service_start_time,service_end_time,service_location_id,NULL,NULL,service_duration,service_color,now(),user_id_proc,now(),user_id_proc,0,NULL,NULL,NULL,uuid());
  END IF;
