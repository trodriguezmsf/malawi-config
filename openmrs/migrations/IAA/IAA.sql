...
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of CVA - TIA","History of CVA - TIA","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of MI","History of MI","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of Rheumatic fever","History of Rheumatic fever","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of anaemia","History of anaemia","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of blood disorder","History of blood disorder","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of cancer","History of cancer","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of cirrhosis","History of cirrhosis","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of corticosteroid drugs","History of corticosteroid drugs","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of frequent bleeding","History of frequent bleeding","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of heart problems (within last six months)","History of heart problems (within last six months)","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of hepatitis","History of hepatitis","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of hypertension","History of hypertension","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of jaundice","History of jaundice","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of palpitations","History of palpitations","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of renal failure","History of renal failure","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of renal infection","History of renal infection","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of renal stones","History of renal stones","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of upper GI bleeding","History of upper GI bleeding","N/A","Misc",false);
call add_concept(@concept_id,@concept_short_id,@concept_full_id,"History of valve disease","History of valve disease","N/A","Misc",false);
